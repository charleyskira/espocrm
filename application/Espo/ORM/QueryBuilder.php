...
class QueryBuilder
{
    ...
    {
        return new SelectBuilder($this->entityManager);
    }

    public function update() : UpdateBuilder
    {
        return new UpdateBuilder($this->entityManager);
    }

    public function delete() : DeleteBuilder
    {
        return new DeleteBuilder($this->entityManager);
    }

    public function insert() : InsertBuilder
    {
        return new InsertBuilder($this->entityManager);
    }
}
